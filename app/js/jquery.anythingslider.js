...
;(function($, win, doc) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.init = function(){
			...
			base.$startStop = $('<button href="#"  id="play" onclick="playAudio();" class="start-stop"></button>');
		...
		base.buildAutoPlay = function(){
			base.$startStop
				.html('<a class="audio-play" href="javascript:;">' + (base.playing ? o.stopText : o.startText) + '</a>')
